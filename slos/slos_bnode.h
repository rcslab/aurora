...
int bnode_putptr(struct bnode *bnode, size_t offset, struct slos_diskptr diskptr);
...
int bnode_copydata(struct bnode *dst, struct bnode *src, 
...
struct bnode *bnode_alloc(struct slos *slos, uint64_t blkno, uint64_t vsize, int external);
